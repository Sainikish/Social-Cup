...
// fail-fast philosophy as mobile/src/config/env.ts. Deliberately no assumed
// URL outside local development: a staging/production build must set
// VITE_API_BASE_URL itself, failing fast here is safer than silently
