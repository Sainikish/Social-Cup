...
// shape) - every paginated backend endpoint returns this. Not used by
// anything in this Phase 1 foundation yet (no list endpoints are consumed
// here), but kept for consistency with mobile/barista-web's own
// src/types/api.ts - later phases (Cafe/Drink/Member/etc. management) will
// need it.
